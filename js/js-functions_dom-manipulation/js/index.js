...
function removeAllColors() {
  box.className = "box"; // Remove all existing classes
}

function addColor(className) {
  removeAllColors(); // Remove all existing classes before adding the new one
  box.classList.add(className); // Add the new class
}
