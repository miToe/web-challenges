...
function findByLastName(employees, lastName) {
  const lastNameInput = employees.find(
...
function findByCitySubString(employees, string) {
  const cityInput = employees.find((employee) =>
...
function findByProfessionSubStringAndAge(employees, string, age) {
  const professionAndAgeInput = employees.find(
    (employee) =>
      employee.profession &&
  ...
  console.log(professionAndAgeInput);

  return professionAndAgeInput;
}
